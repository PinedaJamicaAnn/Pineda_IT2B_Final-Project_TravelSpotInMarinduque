...
<div class="text-box">
	...
	<div style="text-align: center;">
		...
		<div class="row" >
			...
			<div class="column" style="box-shadow: 0px 3px 8px rgba(0, 0, 0, 0.24); margin-left: 100px;">
				<div class="content">
					<img src="images/gasanchurch.jpeg" style="width: 250px;height: 180px; margin-top: -43px; margin-left: -44px;">
					<?php
			...
			<div class="column" style="box-shadow: 0px 3px 8px rgba(0, 0, 0, 0.24); margin-left: 90px;">
				<div class="content">
					<img src="images/gasan-cover.jpg" style="width: 250px;height: 180px; margin-top: -43px; margin-left: -44px;">
					<?php
