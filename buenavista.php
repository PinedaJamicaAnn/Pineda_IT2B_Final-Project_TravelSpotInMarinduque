	...
	<div style="text-align: center;">
		...
		<div class="row" >
			<div class="column" style="box-shadow: 0px 3px 8px rgba(0, 0, 0, 0.24); margin-left: 10px;">
				<div class="content">
					<img src="images/buen-food.jpg" style="width: 250px;height: 180px; margin-top: -43px; margin-left: -44px;">
					<?php
			...
			<div class="column" style="box-shadow: 0px 3px 8px rgba(0, 0, 0, 0.24); margin-left: 100px;">
				<div class="content">
					<img src="images/buen-cover.jpg" style="width: 250px;height: 180px; margin-top: -43px; margin-left: -44px;">
					<?php
			...
			<div class="column" style="box-shadow: 0px 3px 8px rgba(0, 0, 0, 0.24); margin-left: 140px;">
				<div class="content">
					<img src="images/buen-fes.jpg" style="width: 250px;height: 180px; margin-top: -43px; margin-left: -44px;">
					<?php
